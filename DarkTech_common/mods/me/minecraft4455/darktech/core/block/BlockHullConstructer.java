...
public class BlockHullConstructer extends BlockContainer {
	@SideOnly(Side.CLIENT)
	private Icon field_94458_cO;
	@SideOnly(Side.CLIENT)
	private Icon field_94459_cP;
	public BlockHullConstructer(int id) {
		super(id, Material.iron);
		this.setHardness(5.1F);
		this.setResistance(10.5F);
		this.setCreativeTab(DarkTech.tabDtblocks);
        this.setUnlocalizedName("HullConstructer");
	}
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int i, float f, float g, float t) {
        ...
        player.openGui(DarkTech.instance, GUIIDS.HullConstructerID, world, x, y, z);
        return true;
        }
    ...
    public TileEntity createNewTileEntity(World world) {
        return new TileHullConstructer();
    }
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon("minecraft4455:HullConstructer_side");
        this.field_94459_cP = par1IconRegister.registerIcon("minecraft4455:HullConstructer_front");
        this.field_94458_cO = par1IconRegister.registerIcon("minecraft4455:HullConstructer_top");
    }
