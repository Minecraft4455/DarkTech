...
import mods.me.minecraft4455.darktech.core.handler.CraftingManagerHullConstructer;
...
public class ContainerHullConstructer extends Container {

 protected TileHullConstructer tile_entity;
 public InventoryCrafting craftMatrix = new InventoryCrafting(this, 3, 3);
    ...
    public ContainerHullConstructer(InventoryPlayer inventory, TileHullConstructer tile){
   ...
   craftResult.setInventorySlotContents(0, CraftingManagerHullConstructer.getInstance().findMatchingRecipe(craftMatrix, worldObj));
  }
  ...
  public boolean canInteractWith(EntityPlayer par1EntityPlayer){
   if (worldObj.getBlockId(posX, posY, posZ) != DarkTech.HullConstructer.blockID){
    return false;
   }
