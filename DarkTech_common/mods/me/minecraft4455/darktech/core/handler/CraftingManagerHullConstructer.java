package mods.me.minecraft4455.darktech.core.handler;
...
public class CraftingManagerHullConstructer {

 private static final CraftingManagerHullConstructer instance = new CraftingManagerHullConstructer();
 private List<IRecipe> recipes = new ArrayList<IRecipe>();
 
 public static final CraftingManagerHullConstructer getInstance() {
 return instance;
 }
 public CraftingManagerHullConstructer() {
 
	 addRecipe(new ItemStack(DarkTech.WorkBenchWoodenHull), new Object[]{ "PWP", "WKW", "PWP", 'P', Item.stick, 'W', Block.wood, 'K', Block.workbench});
	 addRecipe(new ItemStack(DarkTech.WorkBenchIronHull), new Object[]{ "PWP", "WKW", "PWP", 'P', DarkTech.IronRod, 'W', Block.blockIron, 'K', Block.workbench});
	 addRecipe(new ItemStack(DarkTech.WorkBenchObsidianHull), new Object[]{ "PWP", "WKW", "PWP", 'P', DarkTech.ObsidianRod, 'W', Block.obsidian, 'K', Block.workbench});
	 addRecipe(new ItemStack(DarkTech.WorkBenchDiamondHull), new Object[]{ "PWP", "WKW", "PWP", 'P', DarkTech.DiamondRod, 'W', Block.blockDiamond, 'K', Block.workbench});
